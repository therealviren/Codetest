...
elements.e_nuke = {
    ...
    color: elements.nuke ? elements.nuke.color : "#00ff00",
    hardness: 0.5,
    state: "solid",
...
elements.holy_hand_grenade = {
    color: elements.gold ? elements.gold.color : "#ffd700",
    behavior: [
...
elements.Reniforced_Titanuim = {
    color: "#787878",
    colorPattern: (typeof textures !== "undefined" && textures.Reniforced_Titanuim) ? textures.Reniforced_Titanuim.REINFORCEDTITANIUM : undefined,
    colorKey: {
        "g": "#787878",
        "G": "#606060",
        "i": "#332f2f"
